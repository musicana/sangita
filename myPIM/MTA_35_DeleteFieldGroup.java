...
public class MTA_35_DeleteFieldGroup extends GetBrowserInstance {
	...
	String groupname = "Test_asakash";
	String username = "asxh";
	String password = "123456";
	String Email = "123@gmail.com";
	String[] fieldname = { "fie1", "fci", "fcie" };

	String fieldName = "field4";
