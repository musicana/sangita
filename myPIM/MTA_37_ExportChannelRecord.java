...
public class MTA_37_ExportChannelRecord extends GetBrowserInstance {
	...
	String filepath = "C:\\Users\\Kodamasimham Akash\\Desktop\\Private_thought\\FF_Thoughts.PNG";
	...
	// ----------------- Export records --------------------------- //
	testStep="exportChannel";
		
		uf.exportChannel(driver); // This will export the Record of a particular channel.
		keys.pause(2);
